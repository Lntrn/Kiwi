    ...
    base(str, int, agil, will, power, round) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField(`${Emojis.dmg.pub} ━━ DAMAGE ━━ ${Emojis.dmg.pub}`, 
                        `*boosted by: ${Emojis.str.pub}, ${Format.space(1)}${Emojis.will.pub} & ${Format.space(1)}${Emojis.will.power}*`
            ...
            .addField(`${Emojis.res.pub} ━━━ RESIST ━━━ ${Emojis.res.pub}`, 
                        `*boosted by: ${Emojis.str.pub}, ${Format.space(1)}${Emojis.agil.pub} & ${Format.space(1)}${Emojis.will.power}*`
            ...
            .addField(`${Emojis.acc.pub} ━━ ACCURACY ━━ ${Emojis.acc.pub}`, 
                        `*boosted by: ${Emojis.int.pub}, ${Format.space(1)}${Emojis.agil.pub} & ${Format.space(1)}${Emojis.will.power}*`
    ...
    rating(str, int, agil, will, power, round) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField(`${Emojis.crit.pub} ━━ CRITICAL ━━ ${Emojis.crit.pub}`, 
                        `*boosted by: ${Emojis.agil.pub}, ${Format.space(1)}${Emojis.will.pub} & ${Format.space(1)}${Emojis.will.power}*`
            ...
            .addField(`${Emojis.block.pub} ━━ BLOCK ━━ ${Emojis.block.pub}`, 
                        `*boosted by: ${Emojis.int.pub}, ${Format.space(1)}${Emojis.will.pub} & ${Format.space(1)}${Emojis.will.power}*`
            ...
            .addField(`${Emojis.pip.pub} ━━━ PIPS ━━━ ${Emojis.pip.pub}`, 
                        `*boosted by: ${Emojis.str.pub}, ${Format.space(1)}${Emojis.int.pub} & ${Format.space(1)}${Emojis.will.power}*`
